...
export async function generateMetadata() {
  ...
  // ✅ direct checks only (handles "Contact" vs "contact")
  let seo = null;
  for (const item of data) {
    if (item?.slug === "Contact" || item?.slug === "contact") {
      seo = item;
      break;
    }
  }
  ...
  // fallback if backend hasn't added contact yet
  if (!seo) {
    return {
  ...
  const title = pick(seo.meta_title, seo.name, "Shofy - Contact Page");
