    ...
    <div className="product-col">
      ...
      <style jsx>{`
        :global(.products-grid){
          ...
          gap:24px; margin:0; padding:0; width:100%;
        }
        ...
        .spec-columns{ display:grid; grid-template-columns:1fr 1fr; gap:0 12px; margin-top:8px; flex-grow:1; }
        @media (max-width:340px){ .spec-columns{ grid-template-columns:1fr; } }
        .spec-col{ list-style:none; margin:0; padding:0; }
        .spec-row{ display:flex; align-items:center; padding:4px 0; border-bottom:1px dashed rgba(17,24,39,.06); min-height:22px; }
        .spec-row:last-child{ border-bottom:0; }
        .spec-value{ font-size:12px; font-weight:400; color:#4B5563; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
